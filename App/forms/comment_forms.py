...
class CommentForm(FlaskForm):
    ...
    date_comment = DateField('Fecha de Publicación', validators=[DataRequired()], format='%Y-%m-%d', default=datetime.date.today, render_kw={'readonly': True})
...
class UpdateCommentForm(FlaskForm):
    ...
    date_comment = DateField('Fecha de Publicación', validators=[DataRequired()], format='%Y-%m-%d')
